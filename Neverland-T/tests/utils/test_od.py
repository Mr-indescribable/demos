...
def test_convert():
    ...
    assert isinstance(r, ODict)
    assert isinstance(r.b, ODict)
    assert isinstance(r.b.c, list)
    assert isinstance(r.b.c[1], ODict)
...
def test_update():
    ...
    assert isinstance(container['a'], ODict)
    assert isinstance(container['b'], list)
    assert isinstance(container['b'][2], ODict)
    assert isinstance(container['c'], tuple)
    assert isinstance(container['c'][2], ODict)
